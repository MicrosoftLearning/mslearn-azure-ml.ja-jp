...
1. **[形式を指定してエクスポート]** を展開し、 **[Python (.py)]** を選択してノートブックを Python スクリプトに変換します。
...
1. ノートブックの上部にある [&#9655;&#9655;] アイコンを選択して、**ターミナルでスクリプトを保存して実行します**。 "**Reading data...** " の後、ファイル パスが無効なためデータを取得できなかったことを示すエラーが表示されます。 
